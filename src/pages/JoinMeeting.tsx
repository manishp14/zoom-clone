...
//import { VideoConferenceMode } from '@zegocloud/zego-uikit-prebuilt';
...
export default function JoinMeeting() {
  ...
  const appId = 359570806
  const serverSecret = "334ebb1f7181815cf8e1eaf483b8c747"
  const myMeeting = async (element: any) => {
    ...
    zp?.joinRoom({
      ...
      showTurnOffRemoteCameraButton: true, // or false, depending on your needs
      showTurnOffRemoteMicrophoneButton: true, // or false
      showRemoveUserButton: true, // or false
  });
  };
